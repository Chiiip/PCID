...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="External_RAM_data.mif" NUMWORDS_A=32 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=5 address_a clock0 data_a q_a rden_a wren_a
...
module  External_RAM_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_1.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_3.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_4.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_5.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_6.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_7.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_8.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_9.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_10.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_11.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_12.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_13.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_14.init_file = "External_RAM_data.mif",
	...
	defparam
		...
		ram_block1a_15.init_file = "External_RAM_data.mif",
...
endmodule //External_RAM_altsyncram
//VALID FILE
...
`endif
	...
	External_RAM_altsyncram	External_RAM_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.rden_a (rden),
